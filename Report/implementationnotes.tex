...
The GNU Compiler Collection (GCC) is an optimizing compiler and can using static analysis sometimes recognize that the results and possible side-effects of a computation will not be used in the code and will in those cases completely remove that computation as an optimization.
