...
Later, in Section~\ref{sec:expOptimalBlockSizeDependsOnInputSize}, we show using a fixed block size $b$ for all bitmaps in a wavelet tree, that the optimal $b$ does indeed depend on $n$ and that the practically optimal value of $b$ is below the theoretically optimal size of $b$ for the root bitmap.
