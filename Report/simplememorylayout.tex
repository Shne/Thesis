...
\begin{figure}
\caption{Rank Branch Mis-predictions}
\label{fig:NaiveVsPreallocatedSkewRankQueryBM}
\input{NaiveVsPreallocatedSkewRankQueryBM}
\end{figure}

\begin{figure}
\caption{Select Branch Mis-predictions}
\label{fig:NaiveVsPreallocatedSkewSelectQueryBM}
\input{NaiveVsPreallocatedSkewSelectQueryBM}
\end{figure}

\begin{figure}
\caption{Rank Branch Mis-predictions rate}
\label{fig:NaiveVsPreallocatedSkewRankQuery_BR_CN}
\input{NaiveVsPreallocatedSkewRankQuery_BR_CN}
\end{figure}

\begin{figure}
\caption{Select Branch Mis-predictions rate}
\label{fig:NaiveVsPreallocatedSkewSelectQuery_BR_CN}
