...
This is because the size of the caches are larger in higher levels than in lower levels and \textbf{[TODO: explain this. There is no such thing as \textit{filling up a cache}, they are always filled and every load evicts the previous value]}
