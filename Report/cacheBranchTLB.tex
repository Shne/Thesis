...
Figure~\ref{fig:CacheLevels} \footnote{Figure borrowed from:~\citeA[Section~4.5.1]{Tanenbaum}} shows how the three cache are placed in the relation to the CPU. 
...
To reduce the number of reads needed when a virtual address is translated, a translation lookaside buffer (\textbf{TLB}) is used~\citeA[Section~8.2.5]{OperatingSystemPrinciples}.
