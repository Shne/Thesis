...
From our analysis and tests we find various changes that improve the query running times on the wavelet tree, and also some that worsen the running time even when some of the measurements are improved.
\end{abstract}