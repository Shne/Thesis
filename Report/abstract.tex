...
Inspired by this analysis, we iteratively implement, measure, and analyse variations of the wavelet tree and its queries attempting to reduce the encountered penalties, running time and memory footprint, sometimes comparing with a theoretical analysis.
\end{abstract}