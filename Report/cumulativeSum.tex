...
\begin{subfigure}{0.45\textwidth}
	...
	\caption{Rank: Varying Blocksize for $n=10^8$ characters. The blue line marks expected best block size.}
...
\begin{subfigure}{0.45\textwidth}
	...
	\caption{Build: Varying Blocksize for $n=10^8$ characters}
	\label{fig:CumulativeSumBlockSizeWallTimeBuild}
\end{subfigure}




\caption{Running times of CumulativeSum rank and select for varying block sizes. Notice the x-axis (block size) is logarithmic.}
