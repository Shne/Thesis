...
\textbf{[TODO: redo this paragraph]}In Figure~\ref{fig:CumulativeSumBuild} we have plotted the wall time and memory usage of building the UnalignedNaive and CumulativeSum Wavelet Trees.
...
When taking the performance gain on queries into account then the small  \textbf{[TODO: which is actually faster?]}increased time and memory usage when building the tree is negligible.
