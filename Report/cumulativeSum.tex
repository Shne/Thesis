...
Looking at our code, the alternative methods we have attempted to reduce branches could easily cost much more than 8 clock cycles.
...
In Figure~\ref{fig:CumulativeSumRankL1CM}, Figure~\ref{fig:CumulativeSumRankL2CM}, and Figure~\ref{fig:CumulativeSumRankL3CM} we can see that rank queries on the CumulativeSum wavelet tree has a much better level cache performance, and only slightly worse level 2 and 3 cache performance.
