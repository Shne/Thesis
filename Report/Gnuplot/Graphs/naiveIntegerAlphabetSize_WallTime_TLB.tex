...
\begingroup
  ...
  \begin{picture}(7488.00,4464.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(4696,4181){\makebox(0,0)[r]{\strut{}\large $\frac{Wall Time}{log(\sigma)}$, $mr\hat{\sigma}=$1.688 $avg\hat{\sigma}=$0.81}}%
      \csname LTb\endcsname%
      \put(4696,3741){\makebox(0,0)[r]{\strut{}\large $\frac{TLB Miss}{log(\sigma)}$, $mr\hat{\sigma}=$28.89 $avg\hat{\sigma}=$10.41}}%
    }%
    \gplbacktext
