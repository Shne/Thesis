...
plot '../Data/naiveRankSkew.data' every ::2 using 1:($8/1000) with linespoints title "NaiveRank $mr\\hat{\\sigma}=$".stddevNaiveRankTime." $avg\\hat{\\sigma}=$".stddevNaiveRankTime1, \
'../Data/naiveSelectSkew.data' every ::2 using 1:($8/1000) with linespoints title "NaiveSelect $mr\\hat{\\sigma}=$".stddevNaiveSelectTime." $avg\\hat{\\sigma}=$".stddevNaiveSelectTime1, \
'../Data/controlledNodeMemoryRankSkew.data' every ::2 using 1:($8/1000) with linespoints title "ControlledNodeRank $mr\\hat{\\sigma}=$".stddevControlledRankTime." $avg\\hat{\\sigma}=$".stddevControlledRankTime1, \
'../Data/controlledNodeMemorySelectSkew.data' every ::2 using 1:($8/1000) with linespoints title "ControlledNodeSelect $mr\\hat{\\sigma}=$".stddevControlledSelectTime." $avg\\hat{\\sigma}=$".stddevControlledSelectTime1
