...
plot '../Data/naiveRankSkew.data' every ::2 using 1:2 with linespoints linetype 1 title "NaiveInteger",\
...
plot '../Data/naiveRankSkew.data' every ::2 using 1:3 with linespoints linetype 1 title "NaiveInteger L2",\
	'' every ::2 using 1:3:18 with yerrorbars linetype 1 notitle,\
	'../Data/naiveRankSkew.data' every ::2 using 1:4 with linespoints linetype 2 title "NaiveInteger L3",\
...
plot '../Data/naiveSelectSkew.data' every ::2 using 1:2 with linespoints linetype 1 title "NaiveInteger",\
	'' every ::2 using 1:2:17 with yerrorbars linetype 1 notitle,\
...
plot '../Data/naiveSelectSkew.data' every ::2 using 1:3 with linespoints linetype 1 title "NaiveInteger L2",\
	'' every ::2 using 1:3:18 with yerrorbars linetype 1 notitle,\
	'../Data/naiveSelectSkew.data' every ::2 using 1:4 with linespoints linetype 2 title "NaiveInteger L3",\
	'' every ::2 using 1:4:20 with yerrorbars linetype 2 notitle,\
...
plot '../Data/naiveRankSkew.data' every ::2 using 1:6 with linespoints linetype 1 title "NaiveInteger",\
...
plot '../Data/naiveSelectSkew.data' every ::2 using 1:6 with linespoints linetype 1 title "NaiveInteger",\
	'' every ::2 using 1:6:16 with yerrorbars linetype 1 notitle,\
...
plot '../Data/naiveRankSkew.data' every ::2 using 1:10 with linespoints linetype 1 title "NaiveInteger",\
...
plot '../Data/naiveSelectSkew.data' every ::2 using 1:10 with linespoints linetype 1 title "NaiveInteger",\
	'' every ::2 using 1:10:13 with yerrorbars linetype 1 notitle,\
...
plot '../Data/naiveRankSkew.data' every ::2 using 1:($3/($3+$9)) with linespoints linetype 1 title "NaiveInteger",\
...
plot '../Data/naiveRankSkew.data' every ::2 using 1:($8/1000000) with linespoints linetype 1 title "NaiveInteger",\
...
plot '../Data/naiveSelectSkew.data' every ::2 using 1:($8/1000000) with linespoints linetype 1 title "NaiveInteger",\
	'' every ::2 using 1:($8/1000000):($12/1000000) with yerrorbars linetype 1 notitle,\
