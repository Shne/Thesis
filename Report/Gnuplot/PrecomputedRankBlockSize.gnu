...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):2 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):2 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):2 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):2 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):2 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):2 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):2 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):2 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):($11/1000000) with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):5 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):5 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):5 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):5 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):5 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):5 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):5 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):5 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
set yrange [0:*]
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):4 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):4 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):4 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):4 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):4 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):4 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):4 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):4 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):6 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):6 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):6 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):6 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):6 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):6 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):6 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):6 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):7 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):7 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):7 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):7 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):7 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):7 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):7 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):7 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):($8/($8+$9)) with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):8 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):8 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):8 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):8 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):8 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):8 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):8 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):8 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Rank.data' every ::2 using ($3/32768):10 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):10 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Rank.data' every ::2 using ($3/32768):10 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_rank,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Rank.data' every ::2 using ($3/32768):10 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_rank." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_rank
...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using ($3/32768):10 with linespoints title "Naive, $mr\\hat{\\sigma}=$ ".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".naiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_PreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):10 with linespoints title "Preallocated, $mr\\hat{\\sigma}=$ ".preallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".preallocatedprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using ($3/32768):10 with linespoints title "UnalignedNaive, $mr\\hat{\\sigma}=$ ".unalignednaiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignednaiveprecomputed_avg_stddev_select,\
	'../Data/PrecomputedRankBlockSize_UnalignedPreallocatedPrecomputed_Select.data' every ::2 using ($3/32768):10 with linespoints title "UnalignedPreallocated, $mr\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$ ".unalignedpreallocatedprecomputed_avg_stddev_select
