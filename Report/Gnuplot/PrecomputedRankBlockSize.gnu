...
plot '../Data/PrecomputedRankBlockSize_NaivePrecomputed_Select.data' every ::2 using 3:2 with linespoints title "NaivePrecomputed, $mr\\hat{\\sigma}=$".naiveprecomputed_max_stddev_select." $avg\\hat{\\sigma}=$".naiveprecomputed_avg_stddev_select, \
	...
	# '../Data/PrecomputedRankBlockSize_UnalignedNaivePrecomputed_Select.data' every ::2 using 3:2 with linespoints title "UnalignedNaivePrecomputed, $mr\\hat{\\sigma}=$".unalignednaiveprecomputed_max_stddev." $avg\\hat{\\sigma}=$".unalignednaiveprecomputed_avg_stddev
