...
We query for the Rank of \textit{a} until position $p = 10$.
The number of occurrences of 0s or 1s, depending on how the character is represented, are used as the position in the next level. 
