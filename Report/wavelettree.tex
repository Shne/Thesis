...
Whether we query towards the left or right child in the recursive call is decided by what alphabet (right or left?) the symbol is represented by in the next level.
...
It starts from the leaf of the character and queries up through the tree, which means it is necessary to know the leaf of the character in advance \citep[Section 2.2]{Claude08practicalrankselect}. 
