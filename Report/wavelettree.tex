...
In addition to this, each node takes some constant amount of space, and there are $2 \sigma -1$ nodes in the tree.
This makes the total memory consumption $O(n \log \sigma + \sigma)$.
