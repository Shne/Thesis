...
We can therefore get space usage within \textit{zero-order entropy} even for large alphabets using the wavelet tree. \textit{zero-order entropy} can also be achieved by run-length encoding the bitmaps in the wavelet tree.
