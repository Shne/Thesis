...
Some of the main compression techniques are different ways of encoding the bitmaps and changing the shape of the tree~\citeA[Section~3]{Navarro:2014:WT:2592317.2592708}.
...
Zero-order entropy can also be achieved by run-length encoding the bitmaps in the wavelet tree, which is also the approach that is used when compressing the BWT transformation of the input string using the wavelet tree~\citeA[Introduction (\textbf{B})]{waveletTreeEntropy}.
