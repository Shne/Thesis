...
This use as an positional inverted index can also be extended to \textit{document retrieval}~\citeA[Section 5]{Navjda13} by introducing a document boundary character such as \$ and storing the concatenation of all the documents with the document boundary character in between each.
