...
Rank1CMNoPop = avg(ReadOutput.l1DataCacheMissesArray)
Rank2CMNoPop = avg(ReadOutput.l2DataCacheMissesArray)
...
Rank1CMPop = avg(ReadOutput.l1DataCacheMissesArray)
Rank2CMPop = avg(ReadOutput.l2DataCacheMissesArray)
...
Select1CMNoPop = avg(ReadOutput.l1DataCacheMissesArray)
Select2CMNoPop = avg(ReadOutput.l2DataCacheMissesArray)
...
Select1CMPop = avg(ReadOutput.l1DataCacheMissesArray)
Select2CMPop = avg(ReadOutput.l2DataCacheMissesArray)
