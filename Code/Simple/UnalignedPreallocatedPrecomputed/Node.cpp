...
//    cout << pos << " " << bitmapSize << " " << flush;
    ...
    uint blockMisalignment = bitmapOffset % blockSize; //how far inside a block our part of the bitmap starts
    ...
    if(pos < blockSize && pos < lengthToNextBlockalignment) {
        ...
        uint blockIndex = (bitmapOffset - blockMisalignment) / blockSize;
