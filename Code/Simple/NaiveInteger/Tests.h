...
inline void testSelectTearDown(int argc, char** argv, uint skew){
    ...
    if(argc > 5) {
        ...
        queryOutputFilename = "../../../Output/naiveinteger_select_n" + string(argv[1]) + "_as" + string(argv[2]) + ".output";
    }
...
inline void testRankTearDown(int argc, char** argv, uint skew){
    ...
    if(argc > 5) {
        ...
        queryOutputFilename = "../../../Output/naiveinteger_rank_n" + string(argv[1]) + "_as" + string(argv[2]) + ".output";
    }
    ofstream queryOutput(queryOutputFilename, ios::app);
...
inline void testBuildTearDown(int argc, char** argv, uint skew){
    ...
    if(argc > 5) {
        ...
        queryOutputFilename = "../../../Output/naiveinteger_build_n" + string(argv[1]) + "_as" + string(argv[2]) + ".output";
    }
    ofstream queryOutput(queryOutputFilename, ios::app);
